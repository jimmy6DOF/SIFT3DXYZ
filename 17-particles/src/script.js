...
const tick = () =>
{
    ...
    //Update Particles
    // particles.rotation.y = elapsedTime * 0.2 // commented to make each particle move individually 
    ...
    for(let i = 0; i < count; i++)
    {
        ...
        particlesGeometry.attributes.position.array[i3 + 1] = Math.sin(elapsedTime) * Math.cos(x)
    }

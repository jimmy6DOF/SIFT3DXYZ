...
void main()
{
    ...
    // //Pattern 39 - another amazing one
    // vec2 waveUv = vec2(
    //     vUv.x + sin(vUv.y * 100.0) * 0.10,
    //     vUv.y + sin(vUv.x * 100.0) * 0.10
    // );
    // float strength = 1.0 - step(0.01, abs(distance(waveUv, vec2(0.5)) - 0.25));
    ...
    gl_FragColor = vec4(vUv.yx, strength + vUv.x, 1.0);
}